...
namespace sqlitecrypt {
  ...
  void dbopen(JNIEnv* env, jobject object, jstring pathString, jint flags)
  {
    ...
    if (err != SQLITE_ROW) {
      ...
      if (strcmp(text, "ok") != 0) {
        ...
        jniThrowException(env, "com/sqlitecrypt/database/SQLiteDatabaseCorruptException", text);
        goto done;
      }
    }
#endif
  ...
  int register_android_database_SQLiteDatabase(JNIEnv *env)
  {
    ...
    clazz = env->FindClass("com/sqlitecrypt/database/SQLiteDatabase");
    if (clazz == NULL) {
      LOGE("Can't find com/sqlitecrypt/database/SQLiteDatabase\n");
      return -1;
    }
  ...
  */
  void throw_sqlite3_exception(JNIEnv* env, int errcode,
    ...
    switch (errcode) {
    case SQLITE_IOERR:
      exceptionClass = "com/sqlitecrypt/database/SQLiteDiskIOException";
      break;
    case SQLITE_CORRUPT:
      exceptionClass = "com/sqlitecrypt/database/SQLiteDatabaseCorruptException";
      break;
    case SQLITE_CONSTRAINT:
      exceptionClass = "com/sqlitecrypt/database/SQLiteConstraintException";
      break;
    case SQLITE_ABORT:
      exceptionClass = "com/sqlitecrypt/database/SQLiteAbortException";
      break;
    case SQLITE_DONE:
      exceptionClass = "com/sqlitecrypt/database/SQLiteDoneException";
      break;
    case SQLITE_FULL:
      exceptionClass = "com/sqlitecrypt/database/SQLiteFullException";
      break;
    case SQLITE_MISUSE:
      exceptionClass = "com/sqlitecrypt/database/SQLiteMisuseException";
      break;
    default:
      exceptionClass = "com/sqlitecrypt/database/SQLiteException";
      break;
    }
