...
{
    { "getPagerStats", "(Lcom/sqlitecrypt/database/SQLiteDebug$PagerStats;)V",
            (void*) getPagerStats },
...
int register_android_database_SQLiteDebug(JNIEnv *env)
{
    ...
    clazz = env->FindClass("com/sqlitecrypt/database/SQLiteDebug$PagerStats");
    if (clazz == NULL) {
        LOGE("Can't find com/sqlitecrypt/database/SQLiteDebug$PagerStats");
        return -1;
    }
    ...
    return jniRegisterNativeMethods(env, "com/sqlitecrypt/database/SQLiteDebug",
