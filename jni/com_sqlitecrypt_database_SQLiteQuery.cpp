...
static JNINativeMethod sMethods[] =
{
    ...
    {"native_fill_window", "(Lcom/sqlitecrypt/CursorWindow;IIII)I", (void *)native_fill_window},
...
int register_android_database_SQLiteQuery(JNIEnv * env)
{
    ...
    clazz = env->FindClass("com/sqlitecrypt/database/SQLiteQuery");
    if (clazz == NULL) {
        LOGE("Can't find com/sqlitecrypt/database/SQLiteQuery");
        return -1;
    }
