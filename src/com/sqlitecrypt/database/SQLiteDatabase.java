...
import com.sqlitecrypt.CrossProcessCursorWrapper;
import com.sqlitecrypt.DatabaseUtils;
...
import com.sqlitecrypt.database.SQLiteDebug.DbStats;
...
public class SQLiteDatabase extends SQLiteClosable {
   ...
   */
    public static synchronized void loadLibs (Context context, File workingDir) {
      System.loadLibrary("sqlitecrypt");
      
        // System.loadLibrary("stlport_shared");
        // System.loadLibrary("sqlitecrypt_android");
        // System.loadLibrary("database_sqlitecrypt");
    ...
    public Cursor rawQuery(String sql, String[] selectionArgs,
      ...
      com.sqlitecrypt.CursorWrapper cursorWrapper = (com.sqlitecrypt.CursorWrapper)rawQueryWithFactory(null, sql, selectionArgs, null);
