...
import com.sqlitecrypt.database.SQLiteDatabase.CursorFactory;
    ...
    public synchronized SQLiteDatabase getWritableDatabase(char[] password) {
        ...
        try {
            ...
            if (null != password && password.length > 0) {
                db.execSQL("PRAGMA key='" + String.copyValueOf(password) +"';");
                db.execSQL("PRAGMA lic='73523-019-0000012-53523';");
            }
